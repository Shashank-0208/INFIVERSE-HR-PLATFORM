...
- [Demo-Stable Alignment](runtime-core/demo/DEMO_SCOPE.md)
- [Reusable Hiring Loop Extraction](runtime-core/docs/framework/HIRING_LOOP_OVERVIEW.md)
- [Internal Test Readiness & Truth Lock](runtime-core/docs/TRUTH_MATRIX.md)
- [Current System Reality](runtime-core/docs/system/CURRENT_REALITY.md)
- [Deployment Readiness](runtime-core/docs/sovereign/DEPLOYMENT_READINESS.md)
- [Tenant Isolation Status](runtime-core/docs/security/TENANT_ISOLATION_STATUS.md)
- [Framework Reusability Guide](runtime-core/docs/framework/REUSABILITY_GUIDE.md)
