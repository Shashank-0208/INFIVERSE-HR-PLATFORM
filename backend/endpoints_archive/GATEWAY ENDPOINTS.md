...
GET/v1/candidate/profile/{candidate\_id}; Get Candidate Profile

GET/v1/candidate/stats/{candidate\_id}; Get Candidate Stats

**Recruiter Portal:-**



GET/v1/recruiter/stats; Get Recruiter Stats
